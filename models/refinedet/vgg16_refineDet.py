...
from models.refinedet.refinedet_base import RefineDetHead, transform_output_simple
...
class VGG16_RefineDet(nn.Module):
    ...
    def transform_output(self, model_output, conf_thresh=0.5, nms_threshold=0.5):
        batch_selected_boxes, batch_selected_scores, batch_selected_labels = \
            transform_output_simple(model_output, conf_thresh=conf_thresh, nms_threshold=nms_threshold)
