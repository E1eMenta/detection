...
from models import MobileNetV1_FPN_SSD
...
logdir = os.path.join("mobilenet_fpn_ssd", datetime.datetime.now().strftime("%d-%m-%y_%H-%M"))


# Data
#====================================================================================
model_class = MobileNetV1_FPN_SSD
...
model = MobileNetV1_FPN_SSD(num_classes)
